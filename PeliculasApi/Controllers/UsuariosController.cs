...
namespace PeliculasApi.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController ( UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration, ApplicationDbContext context, IMapper mapper )
        {
        ...
        public async Task<ActionResult<RespuestaAutenticacionDTO>> Registrar ( CredencialesUsuarioDTO credencialesUsuarioDTO )
        {
            ...
            {
                return await ConstruirToken(usuario); // Pass only the required parameters
            }
            else
            {
        ...
        {
            var identityError = new IdentityError(){ Description = "Usuario o contraseña incorrectos" };
